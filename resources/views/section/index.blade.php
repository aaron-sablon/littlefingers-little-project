            ...
            <div class="container-fluid text-left my-3 py-2 border-top border-bottom border-success"> 
                <div class="row">
                    <ul class="list-inline mb-0">
                        ...
                        <li class="list-inline-item"><h4 class="text-secondary">View Section</h4></li>
                    </ul>
                    ...
                    @foreach( $sections as $sec )
                        <tr>
                            ...
                            <td class="text-center">
		      				<a href="{{route('sections.show', $sec->id)}}" class="text-success fa fa-angle-double-right mr-2"></a>
		      			</td>
            ...
            <div class="container">
                ...
                <div class="row">                   
                    <div class="col-sm-2  mt-4">
                        <a  class="btn btn-success btn-block" href="{{route('sections.create')}}" role="button">Add</a>
                    </div>
