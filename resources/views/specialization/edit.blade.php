  ...
  <div class="container mt-4">
      ...
      <div class="container-fluid text-left my-2">     
          <ul class="list-inline mb-1">
              ...
              <li class="list-inline-item"><h4 class="text-secondary">Edit Specialization</h4></li>
          </ul>
      </div>
    ...
    <!-- -->
      ...
      <div class="container">
          <form action="{{ route('specializations.update', $specialization->id) }}" method="post" class="form-inline">
          {{csrf_field()}}
          @method('PUT')             
              <div class="row border-bottom border-top border-success py-3 my-2">
                 ...
                 <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control mb-2 ml-auto w-75" placeholder="Name" name="name" value="{{ $specializations->name }}">
                 </div>
