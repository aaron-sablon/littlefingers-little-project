...
<div class="container col-md-6">
  ...
  <div class="container mt-4">
    ...
    <!-- -->
      ...
      <div class="container">
          <form action="{{ route('rooms.update', $rooms->id ) }}" method="post" class="form-inline">
          {{csrf_field()}}
          @method('PUT')             
              <div class="row border-bottom border-top border-success py-3 my-2">
                 ...
                 <div class="form-group col-sm-6">
                        ...
                        <input type="text" class="form-control mb-2 ml-auto w-75" placeholder="Name" name="name" value="{{ $rooms->name  }}">
                 </div>
